...
const InputWarningModal = ({
  ...
  const getWarningMessage = () => {
    if (titleLength < 2) return warningMessage.TITLE_EMPTY
    else if (titleLength > 19) return warningMessage.TITLE_MAX
    else if (!selectedBread) return warningMessage.CHNANNEL_NULL
    else if (!detailLength) return warningMessage.DETAIL_EMPTY
  }
